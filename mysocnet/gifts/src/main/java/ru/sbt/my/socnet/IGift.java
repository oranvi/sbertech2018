...
public interface IGift { // интерфейс для отправления подарков
    ...
    void makeGift(String gift_id, String friend_id, String text_gift); // * содержит choiceGift()

    void makeGiftConfidentially(String gift_id, String friend_id, String text_gift); // * содержит choiceGift()
